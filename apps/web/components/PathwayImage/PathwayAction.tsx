        ...
        <div style={{ textAlign: 'right', background: '#fff' }}>
            <button className="zoom-in" >
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <circle cx="10" cy="10" r="7" stroke="#B0B0B0" stroke-width="1" />
                    <line x1="10" y1="7" x2="10" y2="13" stroke="#B0B0B0" stroke-width="1" />
                    <line x1="7" y1="10" x2="13" y2="10" stroke="#B0B0B0" stroke-width="1" />
                    <line x1="14.5" y1="14.5" x2="20" y2="20" stroke="#B0B0B0" stroke-width="1" stroke-linecap="round" />
                </svg>
            </button>
            ...
            <button className="zoom-reset" >
                <svg width="40" height="40" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g fill="none" fill-rule="evenodd" stroke="#B0B0B0" stroke-linecap="round" stroke-linejoin="round" transform="translate(3 1)">
