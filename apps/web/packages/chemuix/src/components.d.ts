...
import { EventBody, Node } from "./components/reaction-pathway/reaction-pathway";
import { DataMapperType } from "./components/reaction-pathway/tests/reaction-pathway-wrapper";
export { EventBody, Node } from "./components/reaction-pathway/reaction-pathway";
...
declare global {
   ...
   * using a tree layout algorithm and a 3D rendering engine.
   */
  interface HTMLReactionPathwayElement extends Components.ReactionPathway, HTMLStencilElement {
  }
  var HTMLReactionPathwayElement: {
    prototype: HTMLReactionPathwayElement;
    new(): HTMLReactionPathwayElement;
  };
  interface HTMLReactionPathwayTestWrapperElement extends Components.ReactionPathwayTestWrapper, HTMLStencilElement {
  }
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
       ...
       * using a tree layout algorithm and a 3D rendering engine.
       */
      "reaction-pathway": LocalJSX.ReactionPathway & JSXBase.HTMLAttributes<HTMLReactionPathwayElement>;
      "reaction-pathway-test-wrapper": LocalJSX.ReactionPathwayTestWrapper & JSXBase.HTMLAttributes<HTMLReactionPathwayTestWrapperElement>;
    }
  }
}